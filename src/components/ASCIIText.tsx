...
class CanvasTxt {
  ...
  constructor(txt: string, { fontSize = 200, fontFamily = 'Arial', color = '#000000ff' }: CanvasTxtOptions = {}) {
    this.canvas = document.createElement('canvas');
    this.context = this.canvas.getContext('2d');
    this.txt = txt;
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #000000ff 0%, #7c0000ff 50%, #ff6666ff 100%);
